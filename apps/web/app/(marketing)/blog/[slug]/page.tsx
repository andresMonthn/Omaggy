/** Contexto: Página de detalle del blog. Función: Carga un post por slug desde el CMS, genera metadata SEO/OG/Twitter y renderiza el contenido; devuelve 404 si no existe. */
