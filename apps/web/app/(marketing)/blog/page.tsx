/** Listado del blog. Función: Obtiene posts del CMS con caché, maneja paginación y renderiza previsualizaciones; genera metadata con navegación anterior/siguiente. */
