...
/** ChatBot flotante. Función: Asistente UI con base de conocimiento, integración con `/api/chat`, manejo de candidatos y navegación guiada. */
...
export function ChatBot() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => {
        ...
        base.push({
          id: (botResponse.id || messages.length + 2) + 2,
          sender: "bot",
          component: fallbackComp,
        });
        return base;
  ...
  return (
    <>
      ...
      {/* Ventana de chat */}
      {isOpen && (
        <div ref={chatRef} className="fixed bottom-24 right-4" style={{ zIndex: 2147483647 }}>
          <Card className="shadow-lg flex flex-col border border-border w-96 h-[32rem]">
