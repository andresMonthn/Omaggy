...
/** Proveedor de eventos de la aplicación: gestiona suscripción, emisión y cancelación de listeners. */
const AppEventsContext = createContext<InternalAppEventsContextType | null>(
  null,
);

/** Contenedor que expone `emit`, `on` y `off` para eventos tipados en la app. */
...
/** Hook para usar el bus de eventos: devuelve `emit`, `on` y `off`. */
