...
/**
 * @name UserClaims
 * @description Claims del usuario devueltos por la API de auth de Supabase.
 */
type UserClaims = {
  aud: string;
  exp: number;
...
/**
 * @name requireUser
 * @description Exige sesión activa; opcionalmente verifica MFA y decide redirección.
 * @param client
 * @param options
