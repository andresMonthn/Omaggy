 ...
 * @description Obtiene la Service Role Key de Supabase.
 * USO EXCLUSIVO EN SERVIDOR. NO EXPONER EN CLIENTE.
 */
...
/**
 * Muestra una advertencia si se está usando la Service Role Key.
 */
