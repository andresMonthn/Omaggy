...
/** Contexto: Estado de sesión. Función: Muestra confirmación de pago exitoso y botón para volver al flujo. */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <Button data-test={'checkout-success-back-link'} className={'mb-10'} asChild>
